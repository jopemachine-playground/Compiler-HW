...
//				System.out.println(symbolTable.getVarId(ctx.getChild(0).getText()));

//				expr += "iload_" + symbolTable.getVarId(newTexts.get(ctx.getChild(0)));
//				expr += "iload_" + symbolTable.getVarId(newTexts.get(ctx.getChild(2)));
